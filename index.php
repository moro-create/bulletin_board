    ...
    <div id="content">
      ...
      <?php foreach ($posts as $post) : ?>
        ...
        <div class="msg">
          ...
          <p><?php print(h($post['message'])); ?><span class="name">（<?php print(h($post['name'])); ?>）</span>
          <!-- [<a href="index.php?res=<?php // print(h($post['id'])); ?>">Re</a>]</p> -->
          <p class="day">
            ...
            <?php if ($_SESSION['id'] == $post['member_id']) : ?>
              [<a href="delete.php?id=<?php print(h($post['id'])); ?>" style="color: red; font-weight: bold;">削除</a>]
            <?php endif; ?>
