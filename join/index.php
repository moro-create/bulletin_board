...
// エラー項目の確認
  ...
  // メールアドレスが既に登録されていた際にエラーを出す(重複チェック)
  if (empty($error)) {
...
// URLパラメーターに「action=rewrite」と付いており、かつ$_SESSION['join']に値が入っていれば...
if ($_REQUEST['action'] == 'rewrite') {
  // postの内容にsessionの内容を代入する
  $_POST = $_SESSION['join'];
  $error['rewrite'] = true;
}
  ...
  <div id="wrap">
    ...
    <div id="content">
      ...
      <form action="" method="post" enctype="multipart/form-data">
        <!-- 
        ・enctype="multipart/form-data...決まり文句
        ・ファイルのアップロードが必要な場合は必ず記述する
        -->
        <dl>
